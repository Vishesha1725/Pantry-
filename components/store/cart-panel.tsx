...
export function CartPanel({ count }: { count: number }) {
  return (
    <aside className="rounded-2xl border bg-cocoa p-4 text-cream shadow-cozy">
      <div className="flex items-center gap-3">
        <span className="grid h-12 w-12 place-items-center rounded-2xl bg-coral text-white"><ShoppingCart className="h-6 w-6" /></span>
        <div>
