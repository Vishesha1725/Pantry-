...
const recipeRows = [
  ["paneer-tikka-salad-bowl", "Paneer tikka salad bowl", "bowl", "Fusion", 30, "very_high", "easy", "high", "paneer", ["high_protein", "salad", "bowl", "dinner", "filling"], [ing("paneer", 200, "g", "fresh dairy", "same_day_fresh", fresh), ing("lettuce", 1, "head", "vegetable", "same_day_fresh", fresh), ing("cucumber", 2, "pc", "vegetable", "weekly_fresh", fresh), ing("hung curd", 120, "g", "fresh dairy", "weekly_fresh", fresh), ing("tikka masala", 2, "tsp", "spice", "monthly_staple")]],
  ["tomato-shorba-paneer", "Tomato shorba with roasted paneer cubes", "soup", "Indian", 25, "high", "easy", "high", "paneer", ["high_protein", "soup", "light", "dinner"], [ing("tomatoes", 5, "pc", "vegetable", "weekly_fresh", fresh), ing("paneer", 160, "g", "fresh dairy", "same_day_fresh", fresh), ing("ginger", 1, "inch", "vegetable", "weekly_fresh", fresh), ing("cumin", 1, "tsp", "spice", "monthly_staple")]],
  ["mexican-rajma-bowl", "Mexican rajma bowl", "bowl", "Mexican", 35, "high", "easy", "medium", "rajma", ["high_protein", "bowl", "filling", "spicy", "dinner"], [ing("rajma", 1, "cup", "lentil", "monthly_staple"), ing("rice", 0.75, "cup", "grain", "monthly_staple"), ing("corn", 0.5, "cup", "vegetable", "weekly_fresh", fresh), ing("curd", 100, "g", "fresh dairy", "daily_use", fresh), ing("lettuce", 1, "cup", "vegetable", "same_day_fresh", fresh)]],
  ["thai-peanut-paneer-bowl", "Thai-style peanut paneer bowl without soy sauce", "bowl", "Asian", 30, "very_high", "medium", "high", "paneer", ["high_protein", "bowl", "spicy", "dinner"], [ing("paneer", 200, "g", "fresh dairy", "same_day_fresh", fresh), ing("peanuts", 0.25, "cup", "nuts", "monthly_staple"), ing("coconut milk", 0.5, "cup", "pantry", "monthly_staple"), ing("bell pepper", 2, "pc", "vegetable", "weekly_fresh", fresh), ing("lemon", 1, "pc", "vegetable", "weekly_fresh", fresh)]],
  ["chana-veggie-soup", "Chana veggie soup", "soup", "Indian", 30, "high", "easy", "medium", "chana", ["high_protein", "soup", "light", "dinner"], [ing("chana", 1, "cup", "lentil", "monthly_staple"), ing("carrot", 2, "pc", "vegetable", "weekly_fresh", fresh), ing("spinach", 2, "cups", "greens", "same_day_fresh", fresh), ing("garlic", 4, "cloves", "vegetable", "weekly_fresh", fresh)]],
  ["paneer-bhurji-wrap", "Paneer bhurji wrap", "dinner", "Indian", 20, "very_high", "easy", "high", "paneer", ["high_protein", "quick", "low_effort", "dinner"], [ing("paneer", 200, "g", "fresh dairy", "same_day_fresh", fresh), ing("wraps", 4, "pc", "bakery", "weekly_fresh", fresh), ing("onions", 2, "pc", "vegetable", "weekly_fresh", fresh), ing("tomatoes", 2, "pc", "vegetable", "weekly_fresh", fresh)]],
  ["dal-palak-soup", "Dal palak soup", "soup", "Indian", 30, "high", "easy", "high", "moong dal", ["high_protein", "soup", "light", "dinner"], [ing("moong dal", 0.75, "cup", "lentil", "monthly_staple"), ing("spinach", 3, "cups", "greens", "same_day_fresh", fresh), ing("garlic", 3, "cloves", "vegetable", "weekly_fresh", fresh)]],
  ["masoor-dal-khichdi", "Masoor dal khichdi", "lunch", "Indian", 30, "high", "easy", "low", "masoor dal", ["comfort", "low_effort", "filling"], [ing("masoor dal", 0.75, "cup", "lentil", "monthly_staple"), ing("rice", 0.75, "cup", "grain", "monthly_staple"), ing("ghee", 1, "tbsp", "fat", "monthly_staple")]],
  ["chana-chaat-curd", "Chana chaat bowl with curd dressing", "bowl", "Indian", 20, "high", "easy", "high", "chana", ["high_protein", "quick", "bowl", "spicy"], [ing("chana", 1, "cup", "lentil", "monthly_staple"), ing("curd", 150, "g", "fresh dairy", "daily_use", fresh), ing("cucumber", 2, "pc", "vegetable", "weekly_fresh", fresh), ing("coriander", 1, "bunch", "herbs", "same_day_fresh", fresh)]],
  ["aglio-paneer-bites", "Aglio e olio with paneer bites", "dinner", "Continental", 25, "high", "easy", "high", "paneer", ["high_protein", "quick", "comfort", "dinner"], [ing("pasta", 180, "g", "grain", "monthly_staple"), ing("paneer", 160, "g", "fresh dairy", "same_day_fresh", fresh), ing("garlic", 6, "cloves", "vegetable", "weekly_fresh", fresh), ing("olive oil", 2, "tbsp", "oil", "monthly_staple")]],
  ...
  ["rajma-taco-bowl", "Rajma taco bowl", "bowl", "Mexican", 30, "high", "easy", "medium", "rajma", ["bowl", "spicy", "filling", "dinner"], [ing("rajma", 1, "cup", "lentil", "monthly_staple"), ing("tortilla chips", 1, "cup", "snack", "recipe_based"), ing("curd", 100, "g", "fresh dairy", "daily_use", fresh), ing("tomatoes", 2, "pc", "vegetable", "weekly_fresh", fresh)]],
  ["dahi-kebab-wrap", "High-protein dahi kebab wrap", "dinner", "Fusion", 35, "high", "medium", "high", "hung curd", ["high_protein", "dinner", "comfort"], [ing("hung curd", 250, "g", "fresh dairy", "weekly_fresh", fresh), ing("besan", 0.25, "cup", "flour", "monthly_staple"), ing("wraps", 4, "pc", "bakery", "weekly_fresh", fresh), ing("mint", 1, "bunch", "herbs", "same_day_fresh", fresh)]],
  ...
  ["paneer-pesto-sandwich", "Paneer pesto sandwich", "dinner", "Continental", 18, "high", "easy", "high", "paneer", ["quick", "high_protein", "dinner"], [ing("paneer", 160, "g", "fresh dairy", "same_day_fresh", fresh), ing("bread", 6, "slices", "bakery", "weekly_fresh", fresh), ing("basil pesto", 3, "tbsp", "condiment", "recipe_based"), ing("tomatoes", 2, "pc", "vegetable", "weekly_fresh", fresh)]],
...
export const weeklyEssentials = [
  ...
  ing("milk", 2, "L", "fresh dairy", "daily_use", fresh),
